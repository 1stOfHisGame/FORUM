...
<html>
        ...
        <head><title>Forum - Create User</title>
...
<ul>
 <li><a  href="account.php">Users</a></li>
  ...
  <?php
  if($_SESSION['role']=='admin')
	  echo '<li><a class="active" href="createuser.php">Create User</a></li>';
  ?>
...
<input type="hidden" value="" name="newid"></input>
					<b>User ID</b>
                    <input  type="text" required value="" name="user_id"></input><br>
					<b>Name</b>
                    <input  type="text" required value="" name="name"></input><br>
					<b>Password</b>
                    <input  type="password" required value="" name="pwd" maxlength="20" minlength="3"></input><br> <b>Role</b>
					<input type="radio" name="role"  value="admin"> Admin
					<input type="radio" name="role"  value="manager"> Manager
					<input type="radio" name="role"  value="user" checked> User <br> <b>Status</b>
					<input type="radio" name="status"  value="active" checked> Active 
					<input type="radio" name="status"  value="blocked"> Blocked <br>
					<b>Address</b>
					<input  type="text" value="" name="address"></input><br>
					<b>Age</b>
					<input  type="number"  value="" name="age"></input><br>
					<b>Mobile no.</b>
					<input  type="number" value="" name="mob_no"></input><br><br>
